...
export function BoxItem({ box, boxes, lines, bus, setMode }) {
  ...
  return (
    <group ref={ref} position={box.pos}>
      ...
      {/* top */}
      <group position={[0, 0, BLOCK_HEIGHT / -2 + -SLOT_WIDTH]}>
        <SquareSlot box={box} onClickSlot={onClickSlotInput} io="input" bus={bus} />
      </group>

      {/* bottom */}
      <group position={[0, 0, BLOCK_HEIGHT / 2 + SLOT_WIDTH]}>
        <SquareSlot box={box} onClickSlot={onClickSlotOutput} io="output" bus={bus} />
      </group>
